...
public class P1Typer : MonoBehaviour
{
    public static P1Typer instance;
    ...
    {
        P1ScoreManager.instance.RemovePoints(25);
    ...
    private void SubmitWord()
    {
        if (BinarySearch(wordsList, outputWord) > -1 && ContainsLetters(outputWord, requiredLetters) && NotRepeating())
        {
            ...
            P1ScoreManager.instance.AddPoint(outputWord, comboDecider());
